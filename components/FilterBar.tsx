  ...
  return (
    <form key={searchParams.toString()} className={compact ? "filters search-filter-v60 filters-compact" : "filters search-filter-v60"} onSubmit={onSubmit}>
      <div className="search-filter-grid-v60">
        ...
        <div className="field span-3"><label htmlFor="dateFrom">{t.dateFrom}</label><input id="dateFrom" name="dateFrom" type="text" inputMode="numeric" placeholder={t.datePlaceholder} defaultValue={getInitialValue(searchParams, "dateFrom")} /></div>
        <div className="field span-3"><label htmlFor="dateTo">{t.dateTo}</label><input id="dateTo" name="dateTo" type="text" inputMode="numeric" placeholder={t.datePlaceholder} defaultValue={getInitialValue(searchParams, "dateTo")} /></div>
